...
with c1:
    st.info('**Open Data Source: [LA Open Data](https://data.lacity.org/Community-Economic-Development/Restaurant-and-Market-Health-Violations/ckya-qgys)**', icon="💡")
with c2:
    st.info('**GitHub: [@Project APP](https://github.com/Alleria1809/dsci560_app)**', icon="💻")    
